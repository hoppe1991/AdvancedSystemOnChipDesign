...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,
	...
	\path (A) [edge, midway, above, sloped] edge node {CPU Write Request/-} (B)
		  ...
		  (D) edge node [midway, above, sloped] {Write-Back Is Resolved/Read Cache Block Into Cache From Mem} (E)
	...
	\path (A) [edge, midway, above, sloped] edge node {CPU Read Request/-} (F)
		  ...
		  (H) [edge, midway, above, sloped] edge node {Write-Back Is Resolved/Read Cache Block Into Cache From Mem} (I)
